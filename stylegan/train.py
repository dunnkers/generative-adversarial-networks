...
if 1:
    ...
    resume_run_pkl = 'pickles/network.pkl' # Try to resume training
    resume_kimg   = 15000 # Image number from which to resume (times 1000), affects training schedule
    total_kimg    = 30000 # Times 1000, stops after this

    # Dataset.
    desc += '-vangogh';  dataset = EasyDict(tfrecord_dir='van-gogh');              train.mirror_augment = False
...
def main():
    ...
    kwargs.update(resume_run_id=resume_run_pkl, resume_kimg=resume_kimg, total_kimg=total_kimg)
